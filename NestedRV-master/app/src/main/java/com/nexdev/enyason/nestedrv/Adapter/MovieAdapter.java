...
/*
        ...
        holder.relativeLayout.setOnClickListener(v -> Toast.makeText(context, movie.getName(), Toast.LENGTH_SHORT).show());
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        public MovieViewHolder(View itemView) {
            ...
            relativeLayout = itemView.findViewById(R.id.fulllaMOVIyoutID);
        }
